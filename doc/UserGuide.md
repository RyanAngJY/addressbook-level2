...
### Listing all persons sorted alphabetically: `sortedList`
Shows an alphabetically sorted list of all persons in the address book.<br>
Format: `sortedList`
...
Examples: 
* `find John`<br>
  Returns `john doe`, ignoring letter casing.
* `find Betsy Tim John`<br>
  Returns Any person having names `Betsy`, `Tim`, or `John`, ignoring letter casing.
